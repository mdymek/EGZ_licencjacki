...
*/
    ...
    \begin{figure}[H]
        \includegraphics[width=\linewidth]{graphics/uml_sek.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \includegraphics[width=\linewidth]{graphics/uml_pu.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \includegraphics[width=\linewidth]{graphics/strat_integr.png}
    \end{figure}
