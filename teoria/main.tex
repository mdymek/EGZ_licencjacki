...
cout << *(a+3) << endl;  // 30
    ...
    \begin{itemize}
	\item Łatwiejszą notację - nie musimy używać operatora wyłuskania do odwoływania się do obiektu
...
cout << n << endl; //7
	...
	\textbf{Dziedziczenie (kompozycja)} \\
    	...
    	i ewentualnejmodyfikacji tych właściwości i funkcjonalności w taki sposób, by były one bardziej wyspecjalizowane.
    	\begin{minted}{cpp}
class Mammal {
public:
  void feed() {
...
*/
    ...
    została wywołana meteda z klasy \texttt{Point}, mimo że wskaźnik wskazuje na opiekt typu \texttt{ColoredPoint}. Dzieje się tak, ponieważ kompilator domyślnie
