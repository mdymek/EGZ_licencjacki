...
\begin{document}
   ...
   \section{Wzorce architektury systemów.}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item Komputer z przeglądarką tworzy zapytanie HTTP o stronę \tettt{www.ksi.sh}
    ...
    \begin{enumerate}
        \item Gdy switch odbiera na jakimś porcie ramkę sprawdza on czy adresat (odbiorca) tej ramki znajduje się w tablicy CAM - czy adres MAC odbiorcy się w niej znajduje:
        \begin{enumerate}
            \item Jeżeli tak - ramka wysyłana jest tylko na port powiązany z tym adresem MAC
            \item Jeżeli nie - Switch postąpi podobnie jak Hub - roześle tą ramkę do wszystkich portów. Podobnie postąpi, jeżeli adres MAC odbiorcy jest adresem broadcastowym
        \end{enumerate}
        \item Switch odczytuje z ramki adres MAC nadawcy i wiąże go z portem, na który przyszła ta ramka, oraz zapisuje tą informację w tablicy CAM
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            Jest to najszybsza metoda, ale nie sprawdza się czy nie nastąpiła kolizja i ramka jest niepoprawna.
    ...
    W sieciach komputerowych często zachodzi potrzeba oddzielenia od siebie pewnej komputerów, tak aby mogły one porozumiewać się między sobą w obrębie jednej grupy,
    ...
    Ramki w przypadku technologi VLAN mogą być \textbf{tagowane} lub \textbf{nietagowane}. Te pierwsze to po prostu zwykłe ramki używane do tej pory w sieciach Ethernet.
    ...
    połączenia tylko do jednego interface'u routera, w praktyce dla każdego VLAN'u zostaną na nim utworzone \textbf{wirtualne interface}'y,
    ...
    \begin{enumerate}
        ...
        pasma np. dla 10Mbps koszt wynosił 100, dla 100Mbps koszt
        wynosił 10, itd. Koszty są przekazywane w ramkach BPDU i
