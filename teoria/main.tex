...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item 
            ...
            Rozwiązywany jest problem dla przypadków bazowych (najczęściej jest to możliwe w 
            czasie stałym).
    ...
    \begin{itemize}
        ...
        \item Możliwość łatwego przekształcenia algorytmu w algorytm równownoległy (przy pomocy
            wzorca redukcji / dekompozycji asynchronicznej)

        \item Optymalne użecie pamięci podręcznej (\textit{cache}): problemy dostatecznie małe
            (w szczególności bazowe) bardzo często są możliwe do rozwiązania w pamięci
            nieprzekraczającej wielkości pamięci podręcznej.
        
        \item Algorytmy są znacząco bardziej efektywne w porównaniu do bardziej prymitywnych
    ...
    \begin{itemize}
        \item W przypadku podziału na dwa i więcej podproblemy uzyskujemy rekurencję nieliniową.
            ...
            najprawdopodobniej jest nietrywialne (w szczególności nie zostanie to wykonane przez
            kompilator). 

            
        \item Zarówno algorytm rekurencyjny, jak i algorytm iteracyjny ze stosem może posiadać 
            złożoność pamięciową. Ponadto rozmiar stosu może przekroczyć pamięć komputera.
