...
\begin{document}
    ...
    \begin{theorem}
        \textbf{Zasada indukcji matematycznej.} Niech T(n) - funkcja/forma zdaniową zmiennej $n \in \mathbb{N}$. Jeżeli:
        \begin{enumerate}
            \item zachodzi $T(0)$
    ...
    \begin{definition}
        ...
        Wtedy $(\mathbb{R}, \preceq)$ jest częściowym porządkiem.\\
    ...
    \begin{definition}
        Relację $R \subset X \times X$ nazywamy \textbf{relacją równoważności} $\Leftrightarrow$ relacja R jest:
        \begin{enumerate}
    ...
    \begin{definition}
        ...
        elementu x (względem relacji R) nazywamy:
    ...
    \begin{definition}
        \textbf{Dowód przez kontrapozycję}. Metoda dowodu przez kontrapozycję opiera się na następującej tautologii rachunku
    ...
    \begin{definition}
        ...
        \end{align*}
        Stosując to podejście zakładamy, że p jest fałszem i pokazujemy, że prowadzi to do sprzeczności,
        to znaczy, pokazujemy że zachodzi $q$ oraz $\neg q$, co jest sprzecznością.
    \end{definition}
    \newpage
    ...
    \begin{itemize}
        ...
        \item Kryteria zakończenia obliczeń:
        \begin{itemize}
    ...
    \begin{itemize}
        ...
        $x_n, x_{n+1}$ już są dobrymi \textbf{przybliżeniami pierwiastka}.
    \end{itemize}
    ...
    \begin{definition}
        \textbf{Konfiguracją kombinatoryczną} $B$ o parametrach $(n,k,r)$ nazywamy rodzinę $k$-elementowych podzbiorów w $X$, jeżeli każdy element $x \in X$ występuje w dokładnie $r$ podbiorach. Zachodzą warunki:
        \begin{enumerate}
            \item $n = |X|$
    ...
    \begin{definition}
        ...
        wszystkie wierzchołki. Taki graf nazywamy hamiltonowskim.
    \end{definition}

    \begin{theorem}
        Niech $G = (V, E)$ będzie grafem o $n \geq 3$ wierzchołkach. Jeśli dla dowolnych różnych, niesąsiednich
    ...
    \begin{theorem}
        Niech $G$ będzie grafem spójnym. Wówczas następujące warunki są równoważne:
        \begin{enumerate}
    ...
    \begin{definition}
        \textbf{Kolorowanie wierzchołkowe}. Kolorowaniem wierzchołkowym grafu $G = (V, E)$ przy użyciu (co najwyżej) $k$
    ...
    \begin{definition}
        ...
        której istnieje kolorowanie wierzchołkowe G przy użyciu k kolorów. Oznaczamy $\chi(G)$.
        \begin{enumerate}
    ...
    \begin{definition}
        \textbf{Funkcją tworzącą} (generującą) ciągu $(a_n)$ nazywamy szereg
        \begin{align*}
    ...
    \begin{theorem}
        ...
        \begin{enumerate}
            ...
            wyrazu zerowego). Operacją odwrotną jest odjęcie wyrazu zerowego i podzielenie przez x.
    ...
    \begin{definition}
        ...
        takich wyrazach oznaczamy odpowiednio przez $(a_n)$, $(b_n)$  itp. Zbiór wyrazów ciągu $(a_n)$, tj.
    ...
    \begin{theorem}
        \textbf{Warunek konieczny i wystarczający istnienia granicy}. Funkcja $f$ ma w punkcie $x_0$ granicę
    ...
    \begin{definition}
        ...
        na otoczeniu $O(x_0)$. Funkcja $f$ jest ciągła w punkcie $x_0$ wtedy i tylko wtedy, gdy
        \begin{align*}
    ...
    \begin{theorem}
        \textbf{Warunek konieczny i wystarczający ciągłości funkcji}. Funkcja jest ciągła w punkcie wtedy i tylko wtedy,
    ...
    \begin{theorem}
        ...
        \begin{enumerate}
            \item ekstremum lokalne w punkcie $x_0$,
            \item pochodną $f'(x_0)$,
        \end{enumerate}
        to
        \begin{align*}
